  ...
  return (
    <div className='mt-8 relative overflow-hidden bg-[linear-gradient(90deg,#232121_0%,#000_100%)] shadow-[0_0_21px_0_rgba(149,220,0,0.26)] rounded-[40px] flex lg:flex-row flex-col'>
      <div className="lg:w-1/2 relative shrink-0">
        <img src={imageUrl} className='absolute bottom-0 left-0 w-full lg:block hidden max-w-[616px] right-0 mx-auto'/>
        <div className="uppercase md:text-[100px] text-[80px] text-white font-black text-center lg:mt-5 mt-2">Casino</div>
      </div>
